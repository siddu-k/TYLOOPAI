                ...
                <div className="flex-1 overflow-y-auto px-3 py-2 space-y-6">
                    ...
                    <div>
                        ...
                        <nav className="space-y-1">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-400"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M8 12h8" /><path d="M12 8v8" /></svg>
                                <span>Visualize & Learn</span>
                            </button>
                            <button
                                onClick={() => setCurrentPage('visualize2d')}
                                className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm text-zinc-400 hover:bg-zinc-800/40 hover:text-zinc-50 transition-colors"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-400"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                                <span>2D Vector Visualizer</span>
                            </button>
                            <button
                                onClick={() => setCurrentPage('visualize3d')}
                                className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm text-zinc-400 hover:bg-zinc-800/40 hover:text-zinc-50 transition-colors"
                            >
